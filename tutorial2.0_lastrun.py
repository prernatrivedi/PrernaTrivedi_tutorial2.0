...
expName = 'tutorial2.0'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\dell\\Desktop\\MONSOON 2022\\PSY310 Lab in Psych\\Psychopy tutorial videos\\tutorial2.0_lastrun.py',
